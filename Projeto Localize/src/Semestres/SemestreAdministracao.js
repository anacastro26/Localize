...
export default class SemestreAdministracao extends Component {
    ...
    sala1(){
        this.props.navigation.navigate("Sala 207")
    } 
    sala2(){
        this.props.navigation.navigate("Sala 208")
    }
    sala3(){
      this.props.navigation.navigate("Sala 213")
    }
    sala4(){
      this.props.navigation.navigate("Sala 214")
    }
    render(){
        return (
